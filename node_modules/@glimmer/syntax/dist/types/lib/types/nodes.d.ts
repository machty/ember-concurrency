...
export declare type TopLevelStatement = Template | Block | ElementNode | AttrNode | TextNode | BlockStatement | PartialStatement | CommentStatement | MustacheCommentStatement | MustacheStatement;
