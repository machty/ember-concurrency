...
return i?this.finalize(r,!1):new n(r,!1,!1)}catch(e){return this.finalize(e,!0)}}getIterator(){return this.iterator||this.done||(this.iterator=this.generatorFactory()),this.iterator}finalize(e,t){return this.done=!0,this.iterator=null,new n(e,!0,t)}}var i=s(512),a=s(596),o=s(848),c=s(88)
const u="PERFORM_TYPE_DEFAULT",l="PERFORM_TYPE_UNLINKED",h="PERFORM_TYPE_LINKED",d={}
let p=[]
function f(){return p[p.length-1]}class m{constructor({generatorFactory:e,env:t,debug:s}){this.generatorState=new r(e),this.state=Object.assign({},a.S),this.index=1,this.disposers=[],this.finalizeCallbacks=[],this.env=t,this.debug=s,this.cancelRequest=null}start(){this.state.hasStarted||this.cancelRequest||(this.setState({hasStarted:!0}),this.proceedSync(i.CM,void 0),this.taskInstance.onStarted())}cancel(e){return this.requestCancel(e)?(this.state.hasStarted?this.proceedWithCancelAsync():this.finalizeWithCancel(),this.cancelRequest.promise):(e.finalize(),e.promise)}setState(e){Object.assign(this.state,e),this.taskInstance.setState(this.state)}proceedChecked(e,t,s){this.state.isFinished||this.advanceIndex(e)&&(t===i.gR?(this.requestCancel(new o.Wu(o.i4),s),this.proceedWithCancelAsync()):this.proceedAsync(t,s))}proceedWithCancelAsync(){this.proceedAsync(i.s6,d)}proceedAsync(e,t){this.advanceIndex(this.index),this.env.async((()=>this.proceedSync(e,t)))}proceedSync(e,t){this.state.isFinished||(this.dispose(),this.generatorState.done?this.handleResolvedReturnedValue(e,t):this.handleResolvedContinueValue(e,t))}handleResolvedContinueValue(e,t){let s=this.index,n=this.generatorStep(t,e)
this.advanceIndex(s)&&(n.errored?this.finalize(n.value,c.wp):this.handleYieldedValue(n))}handleResolvedReturnedValue(e,t){switch(e){case i.CM:case i.s6:this.finalize(t,c.ay)
break
case i.GC:this.finalize(t,c.wp)}}handleYieldedUnknownThenable(e){let t=this.index
e.then((e=>{this.proceedChecked(t,i.CM,e)}),(e=>{this.proceedChecked(t,i.GC,e)}))}advanceIndex(e){if(this.index===e)return++this.index}handleYieldedValue(e){let t=e.value
t?(this.addDisposer(t[i.k7]),t[i.Yn]?this.invokeYieldable(t):"function"==typeof t.then?this.handleYieldedUnknownThenable(t):this.proceedWithSimpleValue(t)):this.proceedWithSimpleValue(t)}proceedWithSimpleValue(e){this.proceedAsync(i.CM,e)}addDisposer(e){"function"==typeof e&&this.disposers.push(e)}dispose(){let e=this.disposers
...
e&&e.performType===h||console.warn("You performed a .linked() task without immediately yielding/returning it. This is currently unsupported (but might be supported in future version of ember-concurrency)."),this._expectsLinkedYield=!1}return s}maybeResolveDefer(){this.defer&&this.state.isFinished&&(this.state.completionState===c.ay?this.defer.resolve(this.state.value):this.defer.reject(this.state.error))}onFinalize(e){this.finalizeCallbacks.push(e),this.state.isFinished&&this.runFinalizeCallbacks()}runFinalizeCallbacks(){this.finalizeCallbacks.forEach((e=>e())),this.finalizeCallbacks=[],this.maybeResolveDefer(),this.maybeThrowUnhandledTaskErrorLater()}promise(){return this.defer||(this.defer=this.env.defer(),this.asyncErrorsHandled=!0,this.maybeResolveDefer()),this.defer.promise}maybeThrowUnhandledTaskErrorLater(){this.asyncErrorsHandled||this.state.completionState!==c.wp||(0,o.G0)(this.state.error)||this.env.async((()=>{this.asyncErrorsHandled||this.env.reportUncaughtRejection(this.state.error)}))}requestCancel(e){return!this.cancelRequest&&!this.state.isFinished&&(this.cancelRequest=e,!0)}finalize(e,t){if(this.cancelRequest)return this.finalizeWithCancel()
let s={completionState:t}
t===c.ay?(s.isSuccessful=!0,s.value=e):t===c.wp?(s.isError=!0,s.error=e):t===c.aQ&&(s.error=e),this.finalizeShared(s)}finalizeWithCancel(){let e=this.taskInstance.formatCancelReason(this.cancelRequest.reason),t=new Error(e)
this.debugEnabled()&&console.log(e),t.name=o.Mt,this.finalizeShared({isCanceled:!0,completionState:c.aQ,error:t,cancelReason:e}),this.cancelRequest.finalize()}debugEnabled(){return this.debug||this.env.globalDebuggingEnabled()}finalizeShared(e){this.index++,e.isFinished=!0,this.setState(e),this.runFinalizeCallbacks(),this.dispatchFinalizeEvents(e.completionState)}dispatchFinalizeEvents(e){switch(e){case c.ay:this.taskInstance.onSuccess()
break
case c.wp:this.taskInstance.onError(this.state.error)
break
case c.aQ:this.taskInstance.onCancel(this.state.cancelReason)}}invokeYieldable(e){try{let t=e[i.Yn](this.taskInstance,this.index)
...
s===c.ay?e.proceed(t,i.CM,this.state.value):s===c.wp?e.proceed(t,i.GC,this.state.error):s===c.aQ&&e.proceed(t,i.gR,null)}))
let s=this.getPerformType()
if(s!==l)return()=>{this.detectSelfCancelLoop(s,e),this.cancel(new o.Wu(o.qM))}}getPerformType(){return this.taskInstance.performType||u}detectSelfCancelLoop(e,t){if(e!==u)return
let s=t.executor&&t.executor.cancelRequest
!s||s.kind!==o.ug||this.cancelRequest||this.state.isFinished||this.taskInstance.selfCancelLoopWarning(t)}}},596:(e,t,s)=>{"use strict"
s.d(t,{S:()=>n})
...
var n=s(412),r=s.n(n),i=s(886),a=s(192),o=s(624),c=s(380),u=s(428)
let l="__ec_task_factory"
const h={restartable(){return this[l].setBufferPolicy(u.c),this},enqueue(){return this[l].setBufferPolicy(o.c),this},drop(){return this[l].setBufferPolicy(a.c),this},keepLatest(){return this[l].setBufferPolicy(c.c),this},maxConcurrency(e){return this[l].setMaxConcurrency(e),this},group(e){return this[l].setGroup(e),this},evented(){return this[l].setEvented(!0),this},debug(){return this[l].setDebug(!0),this},onState(e){return this[l].setOnState(e),this}}
...
const f=r()._setClassicDecorator
...
return Object.keys(e).forEach((n=>{s[n]=t(e[n])})),s}return e}(n,W),a=s(r);(0,l.assert)(`'${t}' expects an array.`,Array.isArray(a))
let o=A().defer()
...
e.exports=require("rsvp")},232:(e,t,s)=>{e.exports=function(){var e=_eai_d,t=_eai_r
function n(e){return e&&e.__esModule?e:Object.assign({default:e},e)}window.emberAutoImportDynamic=function(e){return 1===arguments.length?t("_eai_dyn_"+e):t("_eai_dynt_"+e)(Array.prototype.slice.call(arguments,1))},window.emberAutoImportSync=function(e){return t("_eai_sync_"+e)(Array.prototype.slice.call(arguments,1))},e("ember-concurrency",["ember","@ember/object","@ember/application","@ember/destroyable","@ember/runloop","rsvp","@ember/debug","@ember/object/observers"],(function(){return n(s(856))})),e("ember-concurrency/async-arrow-runtime",["@ember/debug","@ember/object","@ember/object/observers","@ember/runloop","ember","rsvp","@ember/application","@ember/destroyable"],(function(){return n(s(252))})),e("ember-concurrency/helpers/cancel-all",["@ember/component/helper","@ember/debug","@ember/object"],(function(){return n(s(84))})),e("ember-concurrency/helpers/perform",["@ember/component/helper","@ember/debug","@ember/object"],(function(){return n(s(572))})),e("ember-concurrency/helpers/task",["@ember/component/helper"],(function(){return n(s(888))})),e("ember-modifier",["@ember/application","@ember/destroyable"],(function(){return n(s(476))})),e("prismjs-glimmer",[],(function(){return n(s(296))}))}()},836:function(e,t){window._eai_r=require,window._eai_d=define},296:(e,t,s)=>{"use strict"
s.r(t),s.d(t,{setup:()=>u})
