...
else c=t(c),i+2<o&&"-"===r[i+1]?(l=t(r[i+2]),i+=2):l=c,a.push([c,l]),l<65||c>122||(l<65||c>90||a.push([32|Math.max(65,c),32|Math.min(l,90)]),l<97||c>122||a.push([-33&Math.max(97,c),-33&Math.min(l,122)]))}for(a.sort(function(e,t){return e[0]-t[0]||t[1]-e[1]}),r=[],c=[NaN,NaN],i=0;i<a.length;++i)o=a[i],o[0]<=c[1]+1?c[1]=Math.max(c[1],o[1]):r.push(c=o)
...
if(e.ignoreCase&&i)for(o=0;o<n;++o)c=t[o],e=c.charAt(0),c.length>=2&&"["===e?t[o]=r(c):"\\"!==e&&(t[o]=c.replace(/[A-Za-z]/g,function(e){return e=e.charCodeAt(0),"["+String.fromCharCode(-33&e,32|e)+"]"}))
...
e.nodeValue=c,(t=t.substring(a.index+a[0].length))&&e.parentNode.insertBefore(o.createTextNode(t),e.nextSibling),r(e),c||e.parentNode.removeChild(e)}}}}function r(e){for(;!e.nextSibling;)if(e=e.parentNode,!e)return
var t
...
for(var p=Math.max(0,t-1|0)||0,h=(u=0,c.length);u<h;++u)a=c[u],a.className="L"+(u+p)%10,a.firstChild||a.appendChild(o.createTextNode(" ")),d.appendChild(a)
e.appendChild(d)}function a(e,t){for(var n=t.length;--n>=0;){var r=t[n]
m.hasOwnProperty(r)?window.console&&console.warn("cannot override language handler %s",r):m[r]=e}}function s(e,t){return e&&m.hasOwnProperty(e)||(e=/^\s*</.test(t)?"default-markup":"default-code"),m[e]}function i(e){var t=e.g
try{var n=(c=function(e){var t,n=/(?:^|\s)nocode(?:\s|$)/,r=[],a=0,s=[],i=0
